...
$(function () {
  ...
  $('.talkBtn').on(downEvent, function (idx) {
    ...
    audio.addEventListener('ended',function(){
      $('.char img').attr('src','images/char/07_cha.png')
    })
  ...
  audio.addEventListener('playing', function () {
    $(
      '.playMotionBtn, .videoBtn, .anitalkBtn, .exviewBtn, .cleanupBtn, .learningBtn, .utilizeBtn, .gotosubBtn, .gotothinkBtn, .popupOpen1, .popupOpen2, .studyBtn, .addBtn, .clickBtn, .supreiBtn, .goTolabBtn,.drawBtn, .arrowLeft, .arrowRight, .playBtn'
  ...
  $('.playBtn, .clickBtn img, .ani>.talkBtn, .supreiBtn, .popupOpen2, .popupOpen1').on(clickEvent,function(){
    console.log(2);
    $('.char img').attr('src','images/char/07_cha.png')
  });
  ...
  $('.videoClose, .simg_btn, .popupOpen1, .popupOpen2').on(
    clickEvent,
    function () {
      $('.scriptBox').hide();
