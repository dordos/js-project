 $(function () {
    ...
    var bindEvent = function() {
        ...
        $('.canvasContainer .colorTool > .color > li').each(function(a, b) {
...
function getZoomRate(DOM) {
    return inViewer() ? (parent.parent.ZOOMVALUE || parent.ZOOMVALUE) : DOM.getBoundingClientRect().width / DOM.offsetWidth;
}
